...
export default function StatCard({ label, value, suffix, color, sparklineData, sparklineType = "area" }: StatCardProps) {
  const barSeries = {
    type: "bar" as const,
    barWidth: "60%",
    itemStyle: {
  ...
  const sparkOption = {
    ...
    yAxis: { type: "value" as const, show: false, min: sparklineType === "area" ? "dataMin" : 0 },
    series: [sparklineType === "bar" ? barSeries : areaSeries],
  };
